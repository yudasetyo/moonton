...
export default function Show() {
    return (
        <section
            className="mx-auto h-screen w-screen relative watching-page bg-form-bg font-poppins"
            id="stream"
        >
            <div className="pt-[100px]">
                <ReactPlayer
                    url="https://www.youtube.com/watch?v=FSRhrTMShTk&ab_channel=YudaSetyoHidayat"
                    controls
                    width={"100%"}
                    height={"850px"}
                />
